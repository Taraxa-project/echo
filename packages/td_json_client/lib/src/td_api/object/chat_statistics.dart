...
class ChatStatisticsSupergroup extends ChatStatistics {
  ...
  ChatStatisticsSupergroup.fromMap(Map<String, dynamic> map) {
    ...
    if (map['message_count'] != null) {
      message_count =
          TdApiMap.fromMap(map['message_count']) as StatisticalValue;
    }
    ...
    if (map['member_count_graph'] != null) {
      member_count_graph =
          TdApiMap.fromMap(map['member_count_graph']) as StatisticalGraph;
    }
    ...
    if (map['join_by_source_graph'] != null) {
      join_by_source_graph =
          TdApiMap.fromMap(map['join_by_source_graph']) as StatisticalGraph;
    }
    if (map['language_graph'] != null) {
      language_graph =
          TdApiMap.fromMap(map['language_graph']) as StatisticalGraph;
    }
    if (map['message_content_graph'] != null) {
      message_content_graph =
          TdApiMap.fromMap(map['message_content_graph']) as StatisticalGraph;
    }
    ...
    if (map['top_senders'] != null) {
      ...
      for (var someValue in map['top_senders']) {
        if (someValue != null) {
          top_senders?.add(
              TdApiMap.fromMap(someValue) as ChatStatisticsMessageSenderInfo);
        }
      }
    }
    if (map['top_administrators'] != null) {
      ...
      for (var someValue in map['top_administrators']) {
        if (someValue != null) {
          top_administrators?.add(TdApiMap.fromMap(someValue)
              as ChatStatisticsAdministratorActionsInfo);
        }
      }
    }
    if (map['top_inviters'] != null) {
      ...
      for (var someValue in map['top_inviters']) {
        if (someValue != null) {
          top_inviters
              ?.add(TdApiMap.fromMap(someValue) as ChatStatisticsInviterInfo);
        }
      }
    }
  }
...
class ChatStatisticsChannel extends ChatStatistics {
  ...
  ChatStatisticsChannel.fromMap(Map<String, dynamic> map) {
    ...
    if (map['mean_view_count'] != null) {
      mean_view_count =
          TdApiMap.fromMap(map['mean_view_count']) as StatisticalValue;
    }
    if (map['mean_share_count'] != null) {
      mean_share_count =
          TdApiMap.fromMap(map['mean_share_count']) as StatisticalValue;
    }
    ...
    if (map['view_count_by_hour_graph'] != null) {
      view_count_by_hour_graph =
          TdApiMap.fromMap(map['view_count_by_hour_graph']) as StatisticalGraph;
    }
    if (map['view_count_by_source_graph'] != null) {
      view_count_by_source_graph =
          TdApiMap.fromMap(map['view_count_by_source_graph'])
              as StatisticalGraph;
    }
    if (map['join_by_source_graph'] != null) {
      join_by_source_graph =
    ...
    if (map['instant_view_interaction_graph'] != null) {
      instant_view_interaction_graph =
          TdApiMap.fromMap(map['instant_view_interaction_graph'])
              as StatisticalGraph;
    }
    if (map['recent_message_interactions'] != null) {
      ...
      for (var someValue in map['recent_message_interactions']) {
        if (someValue != null) {
          recent_message_interactions?.add(TdApiMap.fromMap(someValue)
              as ChatStatisticsMessageInteractionInfo);
        }
      }
    }
  }
