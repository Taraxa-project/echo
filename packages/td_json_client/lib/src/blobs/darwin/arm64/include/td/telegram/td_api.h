...
class premiumGiftOption final : public Object {
 public:
  ...
  static const std::int32_t ID = 2008809959;
  std::int32_t get_id() const final {
    return ID;
  }
...
class getStickers final : public Function {
 public:
  ...
  getStickers(object_ptr<StickerType> &&sticker_type_, string const &emoji_, int32 limit_, int53 chat_id_);

  static const std::int32_t ID = 430950994;
  std::int32_t get_id() const final {
    return ID;
  }
