...
class hellocallback {
  ...
  hellocallback(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  hellocallback.fromLookup(
  ...
  ffi.Pointer<ffi.Int> hello_callback(
  ...
  late final a_hello_callbackPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Int> Function(
              ...
              ffi.Int,
              ffi.Pointer<ffi.Int>,
              ffi.Int)>>('hello_callback');
  late final a_hello_callback = a_hello_callbackPtr.asFunction<
