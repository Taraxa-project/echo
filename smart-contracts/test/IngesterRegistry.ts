...
describe('IngesterRegistry', function () {
  ...
  beforeEach(async function () {
    ...
    [owner, ingester1, ingester2, ingester3, ingester4, controller] = await ethers.getSigners();
    const contractFactory = await ethers.getContractFactory('IngesterRegistry', owner);
